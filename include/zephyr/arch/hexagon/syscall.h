...
static inline uintptr_t arch_syscall_invoke6(uintptr_t arg1, uintptr_t arg2,
					     ...
					     uintptr_t call_id)
{
	register ulong_t r6 __asm__ ("r6") = call_id;
	register ulong_t r0 __asm__ ("r0") = arg1;
	register ulong_t r1 __asm__ ("r1") = arg2;
	register ulong_t r2 __asm__ ("r2") = arg3;
	register ulong_t r3 __asm__ ("r3") = arg4;
	register ulong_t r4 __asm__ ("r4") = arg5;
	register ulong_t r5 __asm__ ("r5") = arg6;
...
{
	register ulong_t r6 __asm__ ("r6") = call_id;
	register ulong_t r0 __asm__ ("r0");
